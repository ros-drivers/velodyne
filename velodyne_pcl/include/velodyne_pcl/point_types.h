...
#ifndef __VELODYNE_PCL_POINT_TYPES_H
#define __VELODYNE_PCL_POINT_TYPES_H

#include <pcl/point_types.h>

namespace velodyne_pcl
{
  /** Velodyne point structure, including intensity and ring number. */
  struct PointXYZIR
  {
...
#endif // __VELODYNE_PCL_POINT_TYPES_H
